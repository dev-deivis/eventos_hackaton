            ...
            <div class="mb-8">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-gray-600 mt-2">Descubre y participa en competencias de desarrollo de software</p>
                    </div>
                    ...
                    <div class="bg-white rounded-xl shadow-sm hover:shadow-xl transition-all duration-300 overflow-hidden border border-gray-100 group">
                        ...
                        <div class="p-6">
                            ...
                            <a href="{{ route('eventos.show', $evento) }}" 
                               class="block w-full text-center bg-indigo-600 hover:bg-indigo-700 text-white font-semibold py-3 px-4 rounded-lg transition-colors duration-200 shadow-md hover:shadow-lg">
                                Ver Detalles
                            </a>
                        </div>
                    </div>
                @empty
                    ...
                    <div class="col-span-full">
                        <div class="bg-white rounded-xl shadow-sm p-12 text-center">
                            ...
                            <p class="text-gray-600 mb-6">Aún no se han creado eventos. ¡Vuelve pronto para ver las próximas competencias!</p>
