    ...
    <div class="py-8">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-8">
                ...
                <p class="text-gray-600 mt-1">Clasificación actual basada en evaluaciones completadas</p>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                ...
                <div class="bg-white rounded-xl shadow-sm p-6 border border-gray-100">
                    <div class="flex items-center justify-between mb-2">
                        <h3 class="text-sm font-medium text-gray-600">Equipos Evaluados</h3>
                    ...
                    <div>
                        <p class="text-4xl font-bold text-pink-600">{{ $equiposEvaluados }}</p>
                        <p class="text-xs text-gray-500 mt-1">De {{ $totalEquipos }} equipos totales</p>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-xl shadow-sm p-6 border border-gray-100">
                    ...
                    <div>
                        <p class="text-4xl font-bold text-pink-600">{{ number_format($promedioGeneral, 0) }}</p>
                        <p class="text-xs text-gray-500 mt-1">Puntos promedio</p>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-xl shadow-sm p-6 border border-gray-100">
                    <div class="flex items-center justify-between mb-2">
                        <h3 class="text-sm font-medium text-gray-600">Mejor Puntuación</h3>
                    ...
                    <div>
                        <p class="text-4xl font-bold text-pink-600">{{ $mejorPuntuacion ? number_format($mejorPuntuacion->calificacion_promedio, 0) : '-' }}</p>
                        <p class="text-xs text-gray-500 mt-1">{{ $mejorPuntuacion ? $mejorPuntuacion->nombre : 'Sin datos' }}</p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100">
                <div class="p-6 border-b border-gray-100">
                    ...
                    <p class="text-sm text-gray-600 mt-1">Rankings actualizados en tiempo real basados en las evaluaciones de todos los jueces</p>
                </div>
                ...
                <div class="divide-y divide-gray-100">
                                ...
                                <div class="flex-shrink-0 w-12 text-center">
                                    ...
                                    @else
                                        <div class="w-12 h-12 bg-gray-100 rounded-full flex items-center justify-center">
                                            <span class="text-xl font-bold text-gray-600">{{ $posicion }}</span>
                                        </div>
                                    @endif
                                </div>
                                ...
                                <div class="flex-1">
                                    <div class="flex items-start justify-between mb-2">
                                        <div class="flex-1">
                                            ...
                                            <p class="text-sm text-gray-600 mb-2">{{ $equipo->proyecto->nombre ?? 'Sin proyecto' }}</p>
                                            <p class="text-xs text-gray-500">{{ $equipo->evento->nombre }}</p>
                                        </div>
                                    ...
                                    <div class="flex items-center gap-6 text-sm text-gray-600 mt-3">
                                        ...
                                        <div class="flex items-center gap-1">
                                            ...
                                            <span class="text-purple-600 font-bold">{{ number_format($equipo->implementacion_promedio, 0) }}</span>
                                        </div>
                                        <div class="flex items-center gap-1">
                    ...
                    @empty
                        ...
                        <div class="p-12 text-center">
                            ...
                            <p class="text-gray-600 mb-6">Los rankings se generarán automáticamente cuando se completen las evaluaciones</p>
