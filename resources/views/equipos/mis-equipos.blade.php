<x-app-layout>
    <div class="py-8">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <!-- Header -->
            <div class="mb-6">
                <h2 class="text-2xl font-bold text-gray-900">Mis Equipos</h2>
                <p class="text-gray-600 mt-1">Selecciona un equipo para ver su progreso</p>
            </div>
                    ...
                    <div class="bg-white rounded-xl shadow-sm hover:shadow-md transition-shadow">
                        ...
                        <div class="p-6 border-b">
                            <div class="flex items-start justify-between mb-3">
                                <div class="flex-1">
                                    <h3 class="text-lg font-bold text-gray-900 mb-1">{{ $equipo->nombre }}</h3>
                            ...
                            @if($equipo->descripcion)
                                <p class="text-sm text-gray-500 line-clamp-2">{{ $equipo->descripcion }}</p>
                            @endif
                        </div>
                        ...
                        <div class="p-6 bg-gray-50">
                            <div class="grid grid-cols-2 gap-4 mb-4">
                                <div>
                                    <p class="text-xs text-gray-600 mb-1">Miembros</p>
                                    <p class="text-lg font-semibold text-gray-900">{{ $equipo->totalMiembros() }}/{{ $equipo->max_miembros }}</p>
                                </div>
                                <div>
                                    ...
                                    @endphp
                                    <p class="text-lg font-semibold text-indigo-600">{{ $progreso }}%</p>
                                </div>
                            </div>
                ...
                @empty
                    <div class="col-span-3">
                        <div class="bg-white rounded-xl shadow-sm p-12 text-center">
                            ...
                            <h3 class="text-lg font-semibold text-gray-900 mb-2">No tienes equipos</h3>
                            <p class="text-gray-600 mb-6">Aún no formas parte de ningún equipo. Explora eventos y únete a uno.</p>
