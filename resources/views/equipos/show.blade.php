                ...
                <div
                    ...
                    <div class="flex items-start justify-between mb-4">
                        <div class="flex-1">
                            ...
                            <p class="text-gray-600 dark:text-gray-400">{{ $proyecto->descripcion }}</p>
                        </div>
                    </div>
                    ...
                    <div class="bg-gray-50 dark:bg-gray-700/50 rounded-lg p-4 mb-4">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-2">
                            ...
                            @php
                                ...
                                $tiene5Miembros = $miembrosActivos === 5;
                            @endphp
                            <div class="flex items-center gap-2">
                                @if ($tiene5Miembros)
                                    <svg class="w-5 h-5 text-green-600 dark:text-green-400 flex-shrink-0" fill="currentColor"
                                ...
                                @endif
                                <span class="text-sm">Equipo de 5 integrantes (actual: {{ $miembrosActivos }})</span>
                            </div>
                            ...
                            <div class="flex items-center gap-2">
                                ...
                                @endif
                                <span class="text-sm">Integrante con rol de Asesor</span>
                            </div>
                        </div>
                    </div>
    ...
    <div id="modalUnirse" class="hidden fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-xl p-6 max-w-md w-full mx-4">
            ...
            <form id="formSolicitarUnirse" method="POST" action="{{ route('equipos.solicitar', $equipo) }}">
                ...
                <div class="mb-4">
                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Selecciona tu rol en el equipo</label>
                    @php
                ...
                <div class="mb-4">
                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">¿Por qué quieres unirte?</label>
                ...
                <div class="flex gap-3">
                    <button type="button" onclick="toggleModalUnirse()"
                        class="flex-1 px-4 py-2 border border-gray-300 text-gray-700 dark:text-gray-300 dark:text-gray-600 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700/50">
                        Cancelar
                    </button>
                    <button type="submit" 
    ...
    <div id="modalCrearTarea"
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-xl p-6 max-w-lg w-full mx-4 max-h-[90vh] overflow-y-auto">
            ...
            <form id="formCrearTarea" method="POST" action="{{ route('equipos.tareas.store', $equipo) }}">
                ...
                <div class="mb-4">
                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Nombre de la Tarea *</label>
                    <input type="text" 
                    ...
                    <div class="flex items-center justify-between mt-1">
                        <p class="text-xs text-gray-500 dark:text-gray-400">Solo letras y números</p>
                ...
                <div class="mb-4">
                    ...
                    <div class="flex items-center justify-between mt-1">
                        <p class="text-xs text-gray-500 dark:text-gray-400">Letras, números y signos de puntuación</p>
                        <p class="text-xs text-gray-500 dark:text-gray-400">
                ...
                <div class="mb-4">
                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Asignar a (máximo 2 personas)</label>
                    <div class="space-y-2 max-h-40 overflow-y-auto border rounded-lg p-3">
                        @foreach ($equipo->participantes as $miembro)
                            <label class="flex items-center gap-2 cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-700/50 p-2 rounded">
    ...
    <div id="modalEditarEquipo"
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-xl p-6 max-w-lg w-full mx-4">
            ...
            <form method="POST" action="{{ route('equipos.update', $equipo) }}" id="formEditarEquipo">
                ...
                <div class="mb-4">
                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Nombre del Equipo *</label>
                    <input type="text" 
                ...
                <div class="mb-4">
                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Descripción del Equipo</label>
