        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-8">
                <div class="flex items-center justify-between">
                    <div>
                        <h1 class="text-3xl font-bold text-gray-900 dark:text-white">Proyectos Pendientes de Aprobación
                        </h1>
                        <p class="text-gray-600 dark:text-gray-400 mt-1">Revisa y aprueba proyectos para que puedan ser
                            evaluados por los jueces</p>
                    </div>
            ...
            @forelse($proyectos as $proyecto)
                <div
                    class="bg-white dark:bg-gray-800 rounded-xl shadow-sm mb-6 border-l-4 border-purple-500 overflow-hidden">
                    <div class="p-6">
                        <!-- Header del Proyecto -->
                ...
                <!-- Modal Asignar Juez -->
                <div id="modalAsignarJuez{{ $proyecto->id }}"
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-xl p-6 max-w-md w-full mx-4">
                        ...
                        <form action="{{ route('admin.proyectos.aprobar', $proyecto) }}" method="POST">
                            ...
                            <div class="mb-4">
                                    ...
                                    <select name="juez_id" required
                                        ...
                                        @foreach ($juecesDisponibles as $juez)
                                            ...
                                            <option value="{{ $juez->id }}">
                                                {{ $juez->name }}
                                                ({{ $proyectosAsignados }}
                                                proyecto{{ $proyectosAsignados != 1 ? 's' : '' }}
                                                asignado{{ $proyectosAsignados != 1 ? 's' : '' }})
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                @else
                                    <div class="bg-yellow-50 border border-yellow-200 rounded-lg p-3">
                                        <p class="text-sm text-yellow-800">⚠️ No hay jueces disponibles en el sistema.
                                        </p>
                                    </div>
                                @endif
                            </div>
                            ...
                            <div class="flex gap-3">
                                <button type="button" onclick="toggleModalAsignarJuez('{{ $proyecto->id }}')"
                                ...
                                <button type="submit" @if ($juecesDisponibles->count() === 0) disabled @endif
                ...
                <div id="modalRechazar{{ $proyecto->id }}"
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-xl p-6 max-w-md w-full mx-4">
                        ...
                        <form action="{{ route('admin.proyectos.rechazar', $proyecto) }}" method="POST">
                            ...
                            <div class="mb-4">
                                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Motivo
                                    del rechazo *</label>
                                ...
                                <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">El equipo recibirá este
                                    mensaje y deberá completar lo que falta</p>
                            </div>
            ...
            @empty
                ...
                <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-12 text-center">
                    ...
                    <h3 class="text-2xl font-bold text-gray-600 dark:text-gray-400 mb-2">No hay proyectos pendientes
                    </h3>
