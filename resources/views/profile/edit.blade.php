<x-app-layout>
    <div class="py-8">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-6">
                ...
                <p class="text-gray-600 dark:text-gray-400 dark:text-gray-500 mt-1">Actualiza tu información personal y habilidades</p>
            </div>
            ...
            <div class="space-y-6">
                ...
                <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-6">
                    <h3 class="text-lg font-bold text-gray-900 dark:text-white mb-6">Información Personal</h3>
                    ...
                    <form method="POST" action="{{ route('profile.update') }}">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <!-- Nombre -->
                            <div>
                                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 dark:text-gray-600 mb-2">Nombre Completo</label>
                                <input type="text" 
                                       name="name" 
                            ...
                            @if(auth()->user()->participante)
                                <!-- Carrera -->
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 dark:text-gray-600 mb-2">Carrera</label>
                                ...
                                <!-- No. Control -->
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 dark:text-gray-600 mb-2">No. Control</label>
                                    <input type="text" 
                                           name="no_control" 
                                ...
                                <!-- Semestre -->
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 dark:text-gray-600 mb-2">Semestre</label>
                                ...
                                <!-- Teléfono -->
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 dark:text-gray-600 mb-2">Teléfono</label>
                                    <input type="text" 
                                           name="telefono" 
                                ...
                                <div class="md:col-span-2">
                                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 dark:text-gray-600 mb-2">Biografía</label>
                                    ...
                                    <div class="flex items-center justify-between mt-1">
                                        <p class="text-xs text-gray-500 dark:text-gray-500">Cuéntanos sobre ti y tus intereses</p>
                        ...
                        <div class="mt-6 flex justify-end gap-3">
                            <a href="{{ route('profile.show') }}" 
                               class="px-6 py-2 border border-gray-300 text-gray-700 dark:text-gray-300 dark:text-gray-600 rounded-lg hover:bg-gray-50 dark:bg-gray-700/50">
                                Cancelar
                            </a>
                            <button type="submit" 
                                    class="px-6 py-2 bg-indigo-600 dark:bg-indigo-500 text-white rounded-lg hover:bg-indigo-700 dark:hover:bg-indigo-600">
                                Guardar Cambios
                            </button>
                        </div>
                    </form>
                ...
                @if(auth()->user()->participante)
                    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-6">
                        <div class="flex items-center justify-between mb-6">
                            <div>
                                <h3 class="text-lg font-bold text-gray-900 dark:text-white">Mis Habilidades</h3>
                                <p class="text-sm text-gray-600 dark:text-gray-400 dark:text-gray-500 mt-1">Agrega las tecnologías y herramientas que dominas</p>
                            </div>
                        ...
                        <div class="space-y-4">
                            @forelse(auth()->user()->participante->habilidades as $habilidad)
                                <div class="flex items-center gap-4 p-4 border border-gray-200 dark:border-gray-600 rounded-lg hover:border-indigo-300 dark:hover:border-indigo-500 transition-colors">
                                    <div class="flex-1">
                                        <div class="flex items-center justify-between mb-2">
                                            <span class="font-semibold text-gray-900 dark:text-white flex items-center gap-2">
                                                <svg class="w-4 h-4 text-gray-500 dark:text-gray-500" fill="currentColor" viewBox="0 0 20 20">
                                    ...
                                    <div class="flex gap-2">
                                        <button onclick="editarHabilidad({{ $habilidad->id }}, '{{ $habilidad->nombre }}', {{ $habilidad->nivel }}, '{{ $habilidad->color }}')" 
                                                class="p-2 text-indigo-600 dark:text-indigo-400 hover:bg-indigo-50 dark:bg-indigo-900/30 rounded-lg">
                                            <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                                        ...
                                        <form method="POST" action="{{ route('profile.habilidad.destroy', $habilidad) }}" 
                                            ...
                                            @method('DELETE')
                                            <button type="submit" 
                                                    class="p-2 text-red-600 dark:text-red-400 hover:bg-red-50 dark:bg-red-900/30 rounded-lg">
                                                <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                ...
                <!-- Cambiar Contraseña -->
                <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-6">
                    <h3 class="text-lg font-bold text-gray-900 dark:text-white mb-6">Cambiar Contraseña</h3>
                    ...
                    <form method="POST" action="{{ route('profile.password') }}" id="formPassword">
                        ...
                        <div class="space-y-4">
                            <div>
                                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 dark:text-gray-600 mb-2">Contraseña Actual</label>
                                <div class="relative">
                                    <input type="password" 
                                           id="current_password"
                                    ...
                                    <button type="button" 
                                            ...
                                            class="absolute right-3 top-1/2 -translate-y-1/2 text-gray-500 dark:text-gray-500 hover:text-gray-700 dark:text-gray-300 dark:text-gray-600">
                            ...
                            <div>
                                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 dark:text-gray-600 mb-2">Nueva Contraseña</label>
                                <div class="relative">
                                    <input type="password" 
                                           id="password"
                                           name="password" 
                                ...
                                <div class="mt-2 space-y-1">
                                    <p class="text-xs font-medium text-gray-700 dark:text-gray-300 dark:text-gray-600">La contraseña debe contener:</p>
                                    <div class="space-y-1 text-xs">
                                        <div id="req-length" class="flex items-center gap-2 text-gray-500 dark:text-gray-500">
                                            <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                                                <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"/>
                                            </svg>
                                            <span>Mínimo 8 caracteres</span>
                                        </div>
                                        <div id="req-upper" class="flex items-center gap-2 text-gray-500 dark:text-gray-500">
                                            <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                                                <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"/>
                                            </svg>
                                            <span>Una letra mayúscula</span>
                                        </div>
                                        <div id="req-lower" class="flex items-center gap-2 text-gray-500 dark:text-gray-500">
                                            <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                                                <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"/>
                                            </svg>
                                            <span>Una letra minúscula</span>
                                        </div>
                                        <div id="req-number" class="flex items-center gap-2 text-gray-500 dark:text-gray-500">
                                            <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                                                <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"/>
                                            </svg>
                                            <span>Un número</span>
                                        </div>
                                        <div id="req-special" class="flex items-center gap-2 text-gray-500 dark:text-gray-500">
                                            <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                                                <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"/>
                                            </svg>
                            ...
                            <div>
                                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 dark:text-gray-600 mb-2">Confirmar Nueva Contraseña</label>
                                <div class="relative">
                                    <input type="password" 
                        ...
                        <div class="mt-6">
                            <button type="submit" 
                                    ...
                                    class="px-6 py-2 bg-indigo-600 dark:bg-indigo-500 text-white rounded-lg hover:bg-indigo-700 dark:hover:bg-indigo-600 disabled:bg-gray-400 disabled:cursor-not-allowed">
    ...
    <div id="modalAgregar" class="hidden fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-xl p-6 max-w-md w-full mx-4">
            <h3 class="text-lg font-bold text-gray-900 dark:text-white mb-4">Agregar Nueva Habilidad</h3>
            ...
            <form method="POST" action="{{ route('profile.habilidad.store') }}">
                ...
                <div class="space-y-4">
                    <div>
                        <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 dark:text-gray-600 mb-2">Nombre de la Habilidad</label>
                        <input type="text" 
                               name="nombre" 
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 dark:text-gray-600 mb-2">Nivel de Dominio (%)</label>
                        <input type="range" 
                               name="nivel" 
                               min="0" 
                               max="100" 
                               ...
                               class="w-full">
                        <div class="text-center text-lg font-semibold text-indigo-600 dark:text-indigo-400 mt-2">50%</div>
                    </div>

                    <div>
                        <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 dark:text-gray-600 mb-2">Color</label>
    ...
    <div id="modalEditar" class="hidden fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-xl p-6 max-w-md w-full mx-4">
            <h3 class="text-lg font-bold text-gray-900 dark:text-white mb-4">Editar Habilidad</h3>
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <input type="range" 
                               ...
                               oninput="this.nextElementSibling.textContent = this.value + '%'"
                               class="w-full">
                        <div id="editNivelDisplay" class="text-center text-lg font-semibold text-indigo-600 dark:text-indigo-400 mt-2">50%</div>
                    </div>
    ...
    <script>
        ...
        function updateSubmitButton() {
            ...
            if (allRequirementsMet && passwordsMatch && confirmationFilled) {
                ...
                btnSubmit.classList.add('bg-indigo-600', 'hover:bg-indigo-700 dark:hover:bg-indigo-600');
            } else {
                btnSubmit.disabled = true;
                btnSubmit.classList.add('bg-gray-400', 'cursor-not-allowed');
                btnSubmit.classList.remove('bg-indigo-600', 'hover:bg-indigo-700 dark:hover:bg-indigo-600');
            }
        }
