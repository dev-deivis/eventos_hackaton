...
print("="*60)
print("Aplicando Modo Oscuro a Vistas de Juez")
print("="*60)

# Reemplazos específicos para completar el modo oscuro
REPLACEMENTS = [
    # Fondos principales
    ...
    (r'hover:bg-purple-600\b', r'hover:bg-purple-600 dark:hover:bg-purple-700'),
    (r'hover:bg-pink-600\b', r'hover:bg-pink-600 dark:hover:bg-pink-700'),
    (r'hover:bg-gray-100\b', r'hover:bg-gray-100 dark:hover:bg-gray-700'),
    (r'hover:bg-gray-50\b', r'hover:bg-gray-50 dark:hover:bg-gray-700/50'),
...
# Procesar solo archivos de juez
views_path = Path('resources/views/juez')
processed = 0
modified = 0

print("\nProcesando archivos de juez...")
print("-" * 60)
...
print("\n" + "="*60)
print("¡Modo oscuro aplicado exitosamente a vistas de Juez!")
print("="*60)
